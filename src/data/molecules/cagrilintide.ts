...
export const CAGRILINTIDE: MoleculeConfig = {
  slug: "cagrilintide",
  name: "Cagrilintide",
  aliases: ["AM833"],
  group: "Metabolic & GLP-1",
  goals: ["weight-loss", "belly-fat"],
  seoTitle: "Cagrilintide: Amylin Analog for Weight",
  metaDescription:
  ...
  usedFor: [
    ...
    },
    {
      ...
      desc: "Studied together with semaglutide to engage both amylin and GLP-1 appetite pathways, the combination that has generated the most clinical interest.",
    },
    {
      heading: "Type 2 diabetes (investigational)",
      desc: "Explored with semaglutide for glycemic control alongside weight reduction in people with type 2 diabetes.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "How is cagrilintide different from semaglutide?",
      answer:
    ...
    {
      question: "Can I get cagrilintide at Strong Health?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Lau DCW, Erichsen L, Francisco AM, et al. Once-weekly cagrilintide for weight management in people with overweight and obesity: a multicentre, randomised, double-blind, placebo-controlled and active-controlled, dose-finding phase 2 trial. Lancet. 2021;398(10317):2160-2172.",
      url: "https://pubmed.ncbi.nlm.nih.gov/34798059/",
    },
  ],
  regulatoryNote:
