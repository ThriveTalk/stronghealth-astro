...
export const RETATRUTIDE: MoleculeConfig = {
  slug: "retatrutide",
  name: "Retatrutide",
  aliases: ["LY3437943", "Triple-G agonist"],
  group: "Metabolic & GLP-1",
  goals: ["weight-loss", "belly-fat"],
  seoTitle: "Retatrutide: Triple-Agonist Weight Loss",
  metaDescription:
    "Retatrutide (LY3437943) is an investigational GIP, GLP-1, and glucagon triple agonist that drove up to 24% weight loss in a phase 2 obesity trial.",
  tagline:
  ...
  primaryUse: "Investigational triple-agonist for weight loss (not FDA-approved)",
  ...
  usedFor: [
    {
      ...
      desc: "The primary focus of retatrutide's development program — substantial, dose-dependent weight reduction in adults with obesity or overweight plus a weight-related condition.",
    },
    {
      heading: "Type 2 diabetes (investigational)",
      desc: "Studied for glycemic control alongside weight loss, consistent with its incretin-hormone mechanism.",
    },
    {
      heading: "Fatty liver disease (investigational)",
      desc: "A phase 2a study explored retatrutide for metabolic dysfunction-associated steatotic liver disease (MASLD), reflecting the glucagon component's effect on liver fat.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "How much weight did people lose on retatrutide?",
      answer:
    ...
    {
      question: "How is retatrutide different from semaglutide or tirzepatide?",
      answer:
    ...
    {
      question: "Can I get retatrutide at Strong Health?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Jastreboff AM, Kaplan LM, Frías JP, et al. Triple–Hormone-Receptor Agonist Retatrutide for Obesity — A Phase 2 Trial. N Engl J Med. 2023;389(6):514-526.",
      url: "https://pubmed.ncbi.nlm.nih.gov/37888926/",
    },
    {
      id: 2,
      text: "Karakasis P, et al. Effects of once-weekly subcutaneous retatrutide on weight and metabolic markers: a systematic review and meta-analysis of randomized controlled trials. 2024.",
