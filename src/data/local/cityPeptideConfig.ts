...
export const MIAMI_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. In-person evaluation at our Miami clinic, followed by telehealth check-ins for dose adjustments and lab reviews.",
  heroCtaMeta:
    "In-person physician visit · On-site labs · No subscriptions · Bilingual (English/Spanish)",

  introHeadingHtml:
    "Miami men are trading med-spa peptide vials for <gold>physician-supervised therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Miami, <gold>prescribed and monitored</gold> like real medicine",
  whyParagraphs: [
    ...
    "We built Strong Health Miami around the principle that peptide therapy is real medicine: contraindications need to be screened, doses need to be titrated, and labs need to be monitored. That's the minimum we consider acceptable.",
  ],
  whyStandardBullets: [
    "Board-certified physicians at our Brickell clinic",
    "In-person physical exam before any peptide is prescribed",
    "On-site lab draws, with no separate Quest or LabCorp trip",
  ...
  steps: [
    ...
    },
    {
      ...
      desc: "We draw a baseline panel on-site: hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs needed for your protocol, so you skip the separate Quest or LabCorp trip.",
    },
    {
  ...
  relatedServices: [
    {
      ...
      desc: "Gold-standard body-composition and bone-density imaging at the Brickell clinic. It's the objective way to see what your peptide protocol is doing.",
  ...
  finalCtaCopy:
    "Book a free assessment at our Brickell clinic. You'll get a physical exam, real bloodwork, and a protocol only if peptide therapy fits your goals.",
    physicalClinic: true,
    parkingTransit:
...
export const DELRAY_BEACH_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. In-person baseline evaluation and on-site labs at our Miami Brickell clinic, followed by telehealth check-ins for dose adjustments and lab reviews.",
  heroCtaMeta:
    "In-person physician visit · On-site labs · No subscriptions · Saturday hours available",

  introHeadingHtml:
    "What Delray Beach patients get from <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide care for Delray Beach that's actually <gold>prescribed and monitored</gold>",
  whyParagraphs: [
  ...
  relatedServices: [
    {
      ...
      desc: "Physician-ordered DEXA body-composition scans at partner imaging centers near you. It's the objective way to see what your protocol is doing.",
...
export const WESTON_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for recovery, performance, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. In-person baseline evaluation and on-site labs at our Miami Brickell clinic, followed by telehealth check-ins for dose adjustments and lab reviews. Bilingual care in English and Spanish.",
  heroCtaMeta:
    "In-person physician visit · On-site labs · No subscriptions · Bilingual (English/Spanish) · Saturday hours available",

  introHeadingHtml:
    "Weston patients are moving their peptides <gold>under physician supervision</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy for Weston, practiced as <gold>real, monitored medicine</gold>",
  whyParagraphs: [
...
/**
 * Pompano Beach (northeast Broward) — telehealth service-area page modeled on
 * Weston. Anchored to the "Strong Health Peptide Therapy Pompano Beach"
 * Google Business Profile (CID 17733331699639354910): the clinic name, geo
 * coordinates, and map embed all mirror the GBP listing so NAP signals stay
 * consistent, while the copy keeps the telehealth + Miami Brickell baseline
 * framing (no Pompano storefront address is published on the profile).
 */
export const POMPANO_BEACH_PEPTIDE_CONFIG: CityPeptideConfig = {
  slug: "pompano-beach",
  cityName: "Pompano Beach",
  county: "Broward County",
  clinicArea: "Pompano Beach service area",

  clinic: {
    name: "Strong Health Peptide Therapy Pompano Beach",
    streetAddress: "",
    city: "Pompano Beach",
    state: "FL",
    postalCode: "",
  ...
  seoDescription:
    "Physician-supervised peptide therapy for Pompano Beach, FL — telehealth, in-person labs at our Miami Brickell clinic. BPC-157, CJC-1295, PT-141. Bilingual care.",
  lastReviewed: "2026-07-26",
  jsonLdPageName: "Peptide Therapy for Pompano Beach, FL — Strong Health (Telehealth + Miami Brickell)",
  jsonLdPageDescription:
    "Physician-supervised peptide therapy for Pompano Beach patients, delivered via telehealth with the in-person baseline evaluation at our Miami Brickell clinic. Pharmacy-grade BPC-157, TB-500, CJC-1295, Ipamorelin, Tesamorelin, PT-141, DSIP, and collagen peptide protocols.",
  reviewedByName: "Dr. Angel Rivera, M.D.",
  reviewedByRole: "Medical Director — Strong Health",

  heroTag: "Pompano Beach Peptide Therapy · Telehealth + Miami Brickell labs",
  reviewRating: "4.9",
  reviewCount: "from 160+ Broward County patient reviews",
  aggregateReviewCount: 160,
  heroDescription1:
    "Physician-supervised peptide protocols for Pompano Beach patients: BPC-157, TB-500, CJC-1295, Ipamorelin, Tesamorelin, PT-141, DSIP, and more. Telehealth visits with the in-person baseline at our Miami Brickell clinic. Pharmacy-grade compounds. Real labs. Ongoing monitoring.",
  heroDescription2:
    "We design individualized peptide therapy protocols for recovery, performance, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. In-person baseline evaluation and on-site labs at our Miami Brickell clinic, followed by telehealth check-ins for dose adjustments and lab reviews. Bilingual care in English and Spanish.",
  heroCtaMeta:
    "In-person physician visit · On-site labs · No subscriptions · Bilingual (English/Spanish) · Saturday hours available",
  ...
  introHeadingHtml:
    "How Pompano Beach patients start <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
    "Pompano Beach has no shortage of places willing to sell you peptides: med spas and wellness lounges along Federal Highway and Atlantic Boulevard, IV-drip bars near the beachfront, recovery studios catering to the city's boaters, anglers, golfers, and pickleball crowd. Peptide therapy done right is physician-led medicine. It starts with bloodwork, not a sales script.",
    "Strong Health designs peptide protocols for Pompano Beach patients around individual labs and goals. Whether you're recovering from a boating, golf, or overuse injury, chasing better performance and energy, dropping visceral belly fat, sleeping through the night again, restoring desire and arousal, or simply maintaining the body composition you work hard for, we use specific peptides for specific clinical reasons, and we monitor the relevant labs throughout the protocol.",
    "Strong Health is a real medical practice with board-certified physicians, on-site lab draws at our Miami Brickell clinic, and pharmacy-compounded medications dispensed under physician orders. Pompano Beach patients are served via telehealth after an in-person baseline at the Brickell clinic, roughly 45 minutes down I-95. We don't sell supplement subscriptions. We don't push gray-market compounds. Every protocol is reviewed at scheduled intervals and adjusted based on how your body actually responds.",
  ],

  whyHeadingHtml:
    "How we prescribe and <gold>monitor</gold> peptide therapy for Pompano Beach",
  whyParagraphs: [
    "Pompano Beach and the surrounding northeast Broward coast have plenty of clinics offering peptides, but very few that combine board-certified physician oversight with on-site labs and pharmacy-grade compounds from licensed compounders. Most Pompano Beach patients we see have already tried at least one place that handed them a vial after a 10-minute video call.",
    "We built Strong Health's Pompano Beach telehealth service around the principle that peptide therapy is real medicine: contraindications need to be screened, doses need to be titrated, and labs need to be monitored. Our Miami Brickell clinic offers bilingual care in English and Spanish, and telehealth follow-ups keep your protocol on track between visits, so you're not fighting I-95 traffic for a routine dose adjustment.",
  ],
  whyStandardBullets: [
    "Board-certified physicians via telehealth + in-person at our Miami Brickell clinic",
    "In-person physical exam before any peptide is prescribed",
  ...
  steps: [
    {
      title: "Start with a telehealth consult, then visit our Miami Brickell clinic for the baseline exam",
      desc: "Your first visit is a video consult with a Strong Health physician. The in-person physical exam, on-site lab draw, and detailed history take place at our Miami Brickell clinic (1000 Brickell Plaza, Miami, FL 33131), about 45 minutes from Pompano Beach down I-95.",
    },
    {
      title: "Comprehensive on-site lab draw",
      desc: "We draw a baseline panel on-site: hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs needed for your protocol, so you skip the separate Quest or LabCorp trip.",
  ...
  physicians: [
    {
      ...
      title: "Supervising Physician & Medical Director",
      credentials:
        "Board-Certified · Medical Director, Strong Health · Oversees peptide protocol design and monitoring for Pompano Beach patients",
      focus:
        "Individualized BPC-157/TB-500, CJC-1295/Ipamorelin, Tesamorelin, PT-141, and DSIP protocols with on-site labs at our Miami Brickell clinic and ongoing telehealth monitoring. Bilingual care in English and Spanish.",
    },
    {
      name: "Strong Health Sports Medicine Team",
      title: "Consulting Specialists, Pompano Beach",
      credentials:
        "Sports Medicine · Tendon & Soft-Tissue Injury Care · Recovery & Performance Optimization",
      focus:
        "Peptide-supported tendon, joint, and soft-tissue healing and performance protocols for Pompano Beach's boating, fishing, golf, tennis, and pickleball communities.",
    },
  ],

  neighborhoods: [
    "Old Pompano", "Palm Aire", "Cresthaven", "Kendall Green", "Cypress Bend",
    "Garden Isles", "Harbor Village", "Santa Barbara Shores", "Leisureville",
    "Lighthouse Point", "Deerfield Beach", "Lauderdale-by-the-Sea", "Sea Ranch Lakes",
    "Oakland Park", "Coconut Creek", "Margate", "Coral Springs", "Fort Lauderdale",
  ],
  neighborhoodAreaName: "northeast Broward County",
  neighborhoodsSubtitle:
    "Strong Health serves peptide therapy patients across Pompano Beach, Lighthouse Point, Deerfield Beach, Lauderdale-by-the-Sea, and the surrounding northeast Broward communities via telehealth, with in-person visits at our Miami Brickell clinic.",

  relatedServices: [
    {
      name: "Peptides for Recovery & Healing",
      desc: "BPC-157 and TB-500 protocols for tendon, joint, and soft-tissue recovery, a frequent starting point for Pompano Beach's active boating, golf, and racquet-sports patients.",
      href: "/peptides-for-healing/",
      cta: "Peptides for healing →",
    },
    {
  ...
  faqs: [
    {
      question: "Where can I get peptide therapy in Pompano Beach, FL?",
      answer:
        "Strong Health serves Pompano Beach peptide-therapy patients by appointment via telehealth, with in-person physician evaluations and on-site lab draws conducted at our Miami Brickell clinic (1000 Brickell Plaza, Miami, FL 33131), about 45 minutes from Pompano Beach down I-95. Follow-up visits are conducted via telehealth statewide. Call (754) 263-6026 to book a free assessment.",
    },
    {
      question: "What peptides does Strong Health prescribe for Pompano Beach patients?",
      answer:
        "Our physicians prescribe pharmacy-grade peptides selected for the patient's specific goals and labs. The most commonly used protocols for Pompano Beach patients include BPC-157 and TB-500 for tendon, joint, and soft-tissue recovery; CJC-1295 with Ipamorelin for performance, body composition, and sleep; Tesamorelin for visceral (belly) fat reduction; PT-141 for sexual desire and arousal; DSIP for deep-sleep architecture; and clinical-grade collagen peptides for connective tissue and skin support. Every protocol is individualized. We don't use one-size-fits-all stacks.",
    },
    {
      question: "Is peptide therapy available in Spanish for Pompano Beach patients?",
      answer:
        "Yes. Strong Health offers bilingual care in English and Spanish, including multiple Spanish-speaking team members and the Medical Director. Many of our Broward County patients prefer to review labs, protocols, and dosing in Spanish, and both telehealth visits and in-person appointments at the Brickell clinic are available in either language.",
    },
    {
      question: "Are peptides legal in Florida?",
      answer:
    ...
    {
      question: "How much does peptide therapy cost for Pompano Beach patients?",
      answer:
        "Your initial telehealth consult is free. Peptide protocols are month-to-month with transparent pricing. Costs vary by peptide, dose, and duration. Most protocols include physician visits, monitoring labs, and pharmacy-compounded medication. We'll review the full cost of your specific protocol before you commit. We do not bill insurance directly, but we provide itemized superbills that many Broward County patients submit to plans like Florida Blue, Aetna, UnitedHealthcare, and Cigna for partial reimbursement.",
    },
    {
      question: "Which peptides are best for sports recovery and performance?",
      answer:
        "For Pompano Beach's active patients (boaters, anglers, golfers, tennis and pickleball players), recovery protocols most often center on BPC-157 and TB-500 for tendon, ligament, and soft-tissue repair, while performance and body-composition goals typically use CJC-1295 with Ipamorelin to support the body's own growth hormone pulses. The right combination depends on your injury history, training load, and labs. Note that GH-secretagogue peptides can trigger anti-doping tests, so competitive athletes should disclose their sport before starting.",
    },
    {
      question: "Do I need an in-person visit, or can I start peptide therapy by telehealth?",
      answer:
        "Florida law and our clinical standards require an in-person physician evaluation before starting peptide therapy. For Pompano Beach patients, that baseline visit is scheduled at our Miami Brickell clinic (1000 Brickell Plaza, Miami, FL 33131) and includes a physical exam, full medical history, on-site lab draw, and a detailed discussion of goals. After your baseline visit, follow-ups are conducted via telehealth, including dose adjustments, lab reviews, and renewal authorizations, with periodic in-person check-ins at the Brickell clinic for labs and physical reassessment.",
    },
    {
      question: "Can peptide therapy be combined with TRT?",
      answer:
        "Yes, and many Pompano Beach patients do exactly that. Strong Health physicians frequently design combined protocols pairing testosterone replacement therapy with GH-secretagogue peptides like CJC-1295/Ipamorelin for body composition and recovery, or with BPC-157 for active patients managing sports-related soft-tissue injuries. Because both therapies are designed and monitored by the same physician using the same lab panels, dose interactions and overall response are tracked together rather than in silos.",
    },
  ],

  finalCtaHeading: "Ready to talk to a Strong Health physician about peptide therapy?",
  finalCtaCopy:
    "Book a free assessment. Telehealth visits for Pompano Beach patients with on-site labs and in-person evaluations at our Miami Brickell clinic.",
  physicalClinic: false,
  parkingTransit:
    "No Pompano Beach storefront. In-person visits and on-site labs are conducted at the Strong Health Miami Brickell clinic (about 45 minutes down I-95); telehealth follow-ups are available statewide.",
  physicianAvailability:
    "Strong Health attending physicians see Pompano Beach patients by appointment via telehealth, with in-person visits scheduled at our Miami Brickell clinic when on-site labs or exams are required.",
  appointmentExpectations:
    "Free first assessment, typically 30–45 minutes. Initial telehealth visit reviews history, goals, and current medications/supplements; on-site biomarker draws are scheduled at the Brickell clinic. Most patients are seen within 5 business days of booking.",
  reviewLinks: [
    {
      label: "Strong Health Peptide Therapy Pompano Beach on Google",
      url: "https://share.google/Kqde12Kl6XGcpzm6p",
    },
  ],
  relatedInternalLinks: [
    { label: "Peptides for healing & recovery", href: "/peptides-for-healing/" },
...
export const NEW_YORK_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in New York, with baseline and monitoring labs drawn at local lab draw sites across the five boroughs.",
  heroCtaMeta:
  ...
  steps: [
    ...
    },
    {
      ...
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you in any of the five boroughs.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
...
export const SAN_DIEGO_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in California, with baseline and monitoring labs drawn at local lab draw sites across San Diego County.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "San Diego men are choosing <gold>physician-supervised peptide therapy</gold> over the gray market",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "San Diego peptide therapy with <gold>physician oversight built in</gold>",
  whyParagraphs: [
  ...
  steps: [
    ...
    {
      title: "Baseline labs at a local draw site",
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you anywhere in San Diego County.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
...
export const LAS_VEGAS_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in Nevada, with baseline and monitoring labs drawn at local lab draw sites across the Las Vegas Valley.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Las Vegas men want peptides with <gold>a physician behind the prescription</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Las Vegas, <gold>prescribed and monitored</gold> properly",
  whyParagraphs: [
  ...
  steps: [
    ...
    {
      title: "Baseline labs at a local draw site",
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you anywhere in the Las Vegas Valley.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
...
export const ATLANTA_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in Georgia, with baseline and monitoring labs drawn at local lab draw sites across metro Atlanta.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Atlanta men are moving to <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Atlanta peptide therapy, held to <gold>a medical standard</gold>",
  whyParagraphs: [
  ...
  steps: [
    ...
    {
      title: "Baseline labs at a local draw site",
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you anywhere in metro Atlanta.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
...
export const AUSTIN_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in Texas, with baseline and monitoring labs drawn at local lab draw sites across the Austin metro.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Where Austin men get <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Austin, <gold>prescribed and monitored</gold> by physicians",
  whyParagraphs: [
  ...
  steps: [
    ...
    {
      title: "Baseline labs at a local draw site",
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you anywhere in the Austin metro.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
...
export const TAMPA_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in Florida, with baseline and monitoring labs drawn at local lab draw sites across the Tampa Bay area.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Tampa men are making the switch to <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Tampa peptide therapy with <gold>labs and follow-up</gold> behind every dose",
  whyParagraphs: [
  ...
  steps: [
    ...
    {
      title: "Baseline labs at a local draw site",
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you anywhere in the Tampa Bay area.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
...
export const NACOGDOCHES_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  introHeadingHtml:
    "Nacogdoches finally has access to <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Nacogdoches, <gold>prescribed and monitored</gold> without the drive",
  whyParagraphs: [
  ...
  steps: [
    {
      title: "Start with a telehealth consult with a Texas–licensed physician",
      desc: "Your first visit is a video consult with a Strong Health physician licensed in Texas, with no drive to Houston, Dallas, or Tyler. You'll review your history, goals, prior treatments, and any musculoskeletal or hormonal concerns.",
    },
    {
      title: "Baseline labs close to home",
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local draw site in Nacogdoches or nearby Lufkin so you're not driving hours for bloodwork.",
    },
    {
      title: "Individualized protocol design",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "It's one of the most common reasons East Texas patients come to us. Years of hard physical work take a toll on rotator cuffs, knees, elbows, and lower backs. BPC-157 and TB-500 protocols are designed to support tendon, ligament, and soft-tissue healing, and they're frequently paired with GH-secretagogue peptides for recovery and sleep. Every protocol is built around your labs and screened for contraindications first. It complements proper orthopedic care rather than replacing it.",
    },
    {
...
export const LOS_ANGELES_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in California, with baseline and monitoring labs drawn at local lab draw sites from the Westside to the Valley, so you're not crawling down the 405 for bloodwork.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "In a city full of peptide sellers, LA men are picking <gold>physician supervision</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Los Angeles under <gold>actual physician oversight</gold>",
  whyParagraphs: [
  ...
  steps: [
    {
      title: "Start with a telehealth consult with a California–licensed physician",
      desc: "Your first visit is a video consult with a Strong Health physician licensed in California, with no drive across the 405 or the 101. You'll review your history, goals, prior treatments, and any musculoskeletal or hormonal concerns.",
    },
    {
      title: "Baseline labs at a local draw site",
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you, from the Westside and South Bay to the Valley and Pasadena.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
  ...
  relatedServices: [
    ...
    {
      name: "Peptides for Muscle Growth",
      desc: "CJC-1295, Ipamorelin, and BPC-157 protocols that support lean mass and recovery, designed around your labs instead of a generic stack.",
      href: "/peptides-for-muscle-growth/",
      cta: "Peptides for muscle growth →",
    },
    {
...
export const RALEIGH_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in North Carolina, with baseline and monitoring labs drawn at local lab draw sites across Raleigh, Cary, and the Triangle.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Raleigh men have done the reading. Now they want <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Raleigh, <gold>prescribed and monitored</gold> like the medicine it is",
  whyParagraphs: [
  ...
  steps: [
    ...
    },
    {
      ...
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you in Raleigh, Cary, Apex, or anywhere in the Triangle.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
  ...
  relatedServices: [
    ...
    {
      name: "Peptides for Belly Fat",
      desc: "Tesamorelin protocols target the visceral (belly) fat that years at an RTP desk put on and that diet alone won't budge.",
      href: "/peptides-for-belly-fat/",
      cta: "Peptides for belly fat →",
    },
    {
...
export const OKLAHOMA_CITY_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in Oklahoma, with baseline and monitoring labs drawn at local lab draw sites across the OKC metro, from Edmond to Norman.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Oklahoma City men no longer need to leave town for <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Oklahoma City, <gold>prescribed and monitored</gold> the right way",
  whyParagraphs: [
  ...
  steps: [
    {
      ...
      desc: "Your first visit is a video consult with a Strong Health physician licensed in Oklahoma, with no flight to a coastal clinic or drive to Dallas. You'll review your history, goals, prior treatments, and any musculoskeletal or hormonal concerns.",
    },
    {
      title: "Baseline labs at a local OKC draw site",
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you in OKC, Edmond, Norman, or anywhere in the metro.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders and shipped to your door. Pharmacy-grade only.",
...
export const BELLEVUE_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in Washington, with baseline and monitoring labs drawn at local lab draw sites across Bellevue and the Eastside.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Why Bellevue men choose <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Bellevue peptide therapy, <gold>prescribed and monitored</gold> on your schedule",
  whyParagraphs: [
  ...
  steps: [
    ...
    },
    {
      ...
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you in Bellevue, Redmond, Kirkland, or Issaquah.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
...
export const SALT_LAKE_CITY_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in Utah, with baseline and monitoring labs drawn at local lab draw sites from Downtown and Sugar House to Sandy, Draper, and Lehi.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Salt Lake City men are turning to <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Salt Lake City with <gold>real monitoring</gold> behind it",
  whyParagraphs: [
  ...
  steps: [
    ...
    },
    {
      ...
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you, from Salt Lake proper to Sandy, Draper, and Lehi.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders. Pharmacy-grade only.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "It's the most common reason Wasatch Front patients come to us. Knees, shoulders, and elbows take a beating between ski seasons, climbing trips, and trail-running blocks. BPC-157 and TB-500 protocols are designed to support tendon, ligament, and soft-tissue healing, and they're frequently paired with GH-secretagogue peptides for recovery and sleep. Every protocol is built around your labs and screened for contraindications first. It complements proper orthopedic care rather than replacing it.",
    },
    {
...
export const KANSAS_CITY_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  heroDescription2:
    "We design individualized peptide therapy protocols for healing, body composition, sleep, sexual health, and longevity, built around your bloodwork rather than a generic stack. Telehealth evaluations with physicians licensed in your state, with baseline and monitoring labs drawn at local lab draw sites on both sides of the state line.",
  heroCtaMeta:
    "Telehealth physician visits · Local lab draw sites · No subscriptions",

  introHeadingHtml:
    "Kansas City men are switching to <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
    "Kansas City's peptide options have mostly been med spas on the Plaza, IV lounges in Westport, and online stores shipping \"research-grade\" vials to your door. Plenty of places will sell to you; very few practice actual medicine. Peptide therapy done right is physician-led care that starts with bloodwork, not a sales script.",
  ...
  steps: [
    ...
    },
    {
      ...
      desc: "Your baseline panel covers hormones (testosterone, estradiol, IGF-1), metabolic markers, and any peptide-specific labs your protocol needs. We send the order to a local lab draw site near you, anywhere in the metro from North Kansas City to Overland Park.",
    },
    {
      title: "Individualized protocol design",
      desc: "Your physician selects the right peptide(s), dose, and timing based on your labs and goals. Compounded by a licensed 503A or 503B pharmacy under physician orders and shipped to your door. Pharmacy-grade only.",
  ...
  relatedServices: [
    ...
    {
      name: "Peptides for Belly Fat",
      desc: "Tesamorelin protocols target the visceral (belly) fat that Kansas City barbecue and desk years put on and that diet alone won't budge.",
      href: "/peptides-for-belly-fat/",
      cta: "Peptides for belly fat →",
    },
    {
