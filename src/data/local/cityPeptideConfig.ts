...
export const POMPANO_BEACH_PEPTIDE_CONFIG: CityPeptideConfig = {
  ...
  introHeadingHtml:
    "Why Pompano Beach patients are switching to <gold>physician-supervised peptide therapy</gold>",
  introParagraphs: [
  ...
  whyHeadingHtml:
    "Peptide therapy in Pompano Beach, the way it should be <gold>prescribed and monitored</gold>",
  whyParagraphs: [
